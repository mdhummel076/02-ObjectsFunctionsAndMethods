...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50),30,20,'orange',5)
    #even_better_draw_circles(rg.Point(-200,0),2,60,'blue',10)

    even_better_draw_circles(rg.Point(100, 50), 30, 20, 'orange', 5)
    even_better_draw_circles(rg.Point(-200, 0), 2, 60, 'blue', 10)
    even_better_draw_circles(rg.Point(100, -100), 20, 10, 'green', 1)
    even_better_draw_circles(rg.Point(0, 0), 50, 5, 'yellow', 30)
...
def better_draw_circles(point,dr):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(k * dr)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,dr,num,color,thickness):
